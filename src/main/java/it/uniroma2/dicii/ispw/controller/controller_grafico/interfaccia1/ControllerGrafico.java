...
public abstract class ControllerGrafico {
    public abstract void inizializza(IdSessioneBean id, CampoSenzaFotoBean campoSenzaFoto, FotoBean foto, PartitaBean richiestaPartita) throws SystemException, IOException;
